    ...
    <section className="py-16 px-6">
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          className="bg-card rounded-2xl px-8 py-6 gradient-border"
        >
          {/* Header */}
          <div className="flex items-center justify-between mb-5 flex-wrap gap-3">
            <div className="flex items-center gap-3">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="text-accent shrink-0" viewBox="0 0 24 24">
              ...
              <span className="font-mono text-sm text-accent tracking-widest uppercase">GitHub Activity</span>
              {total !== null && (
            ...
            <a
              ...
              className="relative z-10 font-mono text-xs text-accent border border-accent/30 rounded-lg px-4 py-2 hover:bg-accent/10 transition-colors duration-200 whitespace-nowrap"
            >
              View Profile →
            </a>
          </div>
          ...
          {data ? (
              ...
              <div className="inline-block min-w-max">
                ...
                <div className="flex mb-1 ml-0" style={{ gap: '3px' }}>
                  {weeks.map((_, wi) => {
                    ...
                    return (
                      <div key={wi} className="w-[10px] font-mono text-[9px] text-muted leading-none">
                        {label ? label.label : ''}
                      </div>
                    )
                  })}
            ...
            <div className="h-20 flex items-center justify-center">
              <span className="font-mono text-xs text-muted animate-pulse">Loading contributions…</span>
            </div>
          )}
